---
title: Parcelable 和 Bundle
description: Parcelable 和 Bundle 对象可跨进程边界使用，例如与 IPC/Binder 事务之间，带有 intent 的 Activity 之间等，还可以用来存储跨配置更改的瞬时状态。本页介绍了使用 Parcelable 和 Bundle 对象的建议和最佳?
categories: [Android]
tags: [android, Parcelable, Bundle]
created: 2023-10-05
---
