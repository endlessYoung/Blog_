...
function apply(collapsed: boolean): void {
  document.documentElement.classList.toggle('vp-sidebar-collapsed', collapsed)
...
function toggle(): void {
  const collapsed = document.documentElement.classList.contains('vp-sidebar-collapsed')
  apply(!collapsed)
}
...
.sidebar-toggle[aria-expanded='false']:active svg {
